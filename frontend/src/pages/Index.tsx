  ...
  const features = [
    {
      ...
      description:
        "Get AI-powered crop recommendations based on your soil, climate, and market conditions.",
      icon: TrendingUp,
      image: cropIcon,
    ...
    },
    {
      ...
      description:
        "Upload plant images for instant disease identification and treatment recommendations.",
      icon: Leaf,
      image: diseaseIcon,
      buttonText: "Scan Plant",
      onClick: () =>
        document
          .getElementById("disease")
          ?.scrollIntoView({ behavior: "smooth" }),
    },
    {
      title: "Government Schemes",
      description:
        "Access information about subsidies, loans, and government support programs for farmers.",
      icon: Shield,
      image: schemesIcon,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to make informed farming decisions, from crop
              selection to disease management and financial support.
            </p>
          </div>
